...
#define MAX_FILENAME 51200
#define READ_SIZE 819200
...
#define commonThemepath "ux0:customtheme/c/common_theme"
    ...
    snprintf(file_url, 512, "https://vstema.com/themes/%s", file_name);
    ...
    snprintf(install_dir, 512, "ux0:customtheme/c/%s",
             file_name); //le pongo el / al final del nombre de la carpeta para que ahi guarde los archivos descomprimidos
    ...
    strcpy(sqlinsertquery,
           "INSERT INTO tbl_theme (id,packageImageFilePath,homePreviewFilePath,startPreviewFilePath,contentVer,size,type) VALUES ('");
    strcat(sqlinsertquery, commonThemepath); //no tiene el / al final
    strcat(sqlinsertquery,
           "', 'preview_thumbnail.png', 'preview_page.png', 'preview_lockscreen.png', '100', '0', '100'");
    strcat(sqlinsertquery, ")");
...
void install_liveareatheme() {
    ...
    snprintf(install_dir, 512, "ux0:customtheme/u/%s",
             file_name); //le pongo el / al final del nombre de la carpeta para que ahi guarde los archivos descomprimidos
...
void install_vitashelltheme() {
    ...
    */
    ...
    //					sceKernelDelayThread(5* 1000*1000);
    snprintf(install_dir, 512, "ux0:VitaShell/theme/%s",
             file_name); //le pongo el / al final del nombre de la carpeta para que ahi guarde los archivos descomprimidos
    int length;
    length = strlen(install_dir);//Get length of string
    install_dir[length -
        ...
        switch (key) {
            ...
            case SCE_CTRL_CIRCLE:
                ...
                drawText(13,
                         ...
                         white);
                sceKernelDelayThread(3 * 1000 * 1000); // 3 seconds
                sceAppMgrLaunchAppByUri(0xFFFFF, "https://vstema.com/livearea");
                sceKernelDelayThread(10000);
                sceAppMgrLaunchAppByUri(0xFFFFF, "https://vstema.com/livearea");
                sceKernelExitProcess(0);
